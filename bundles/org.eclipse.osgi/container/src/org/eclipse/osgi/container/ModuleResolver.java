...
final class ModuleResolver {
	...
	class ResolveProcess extends ResolveContext implements Comparator<Capability>, FelixResolveContext, Executor {
		...
		private Map<Resource, List<Wire>> resolveNonPayLoadFragments() {
			...
			List<ModuleRevision> dynamicAttachableFrags = new ArrayList<ModuleRevision>();
			if (triggersMandatory) {
			...
			Map<ModuleCapability, DynamicFragments> hostDynamicFragments = new HashMap<ModuleCapability, DynamicFragments>();
			...
			Map<Resource, List<Wire>> dynamicWires = new HashMap<Resource, List<Wire>>();
